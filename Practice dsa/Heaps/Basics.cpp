...
class heap{
    ...
    void deleteFromHeap(){
        //delete function always delete the root node
        if(size==0){
        ...
        int i=1;
        while(i<size){
            //for 1 based indexing left child=2*i and right child=2*i+1
...
int main(){
    ...
    cout<<"Printing the heap array"<<endl;
    for(int i=1;i<=n;i++){
        cout<<arr[i]<<" ";
    }
    cout<<endl;
